...
<li>💻 Me encuentro trabajando en <a href = "[https://www.ecomsur.com/]">Ecomsur</a></li>
<li>📚 Actualmente estoy aprendiendo: <strong>TypeScript</strong> y <strong>React</strong></li>
...
Palabras clave: JavaScript, Node.js, HTML5, CSS, Firebase, React, Git, GitHub, Visual Studio Code, Figma, Adobe Illustrator, Adobe Photoshop, Adobe Indesign, Trello, Notion, Slack.
